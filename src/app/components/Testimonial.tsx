...
// sample data fro projects with various categories
const slides = [
  {
    img: "/assets/testimonial/img-1.png",
    name: "Emma Johnson",
    message:
      "The service was fantastic! Highly recomend it to anyone looking for top notch design.",
  },
  {
...
const Testimonial = () => {
  const [swiperRef, setSwiperRef] = useState<ISwiper | null>(null);
  ...
  return (
    <div className="py-2 overflow-hidden mt-20 px-8">
