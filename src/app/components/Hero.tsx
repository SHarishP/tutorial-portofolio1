      ...
      <div className="container mx-auto h-full">
        <div className="relative z-20 h-full w-full xl:max-w-[768px] flex flex-col items-center xl:items-start justify-center text-center xl:text-left pt-10">
          <h1 className="h1 mb-2 max-w-[320px] xl:max-w-none">
            ...
            {/* Code untuk membuat animasi string */}
            <TypeAnimation
        ...
        <div className="hidden xl:flex w-[55vw] h-[800px] absolute top-0 right-0 bg-accent">
          ...
          {/* 12. Gunakan component RotatingShape */}
          {/* shape 1*/}
          <div
            className="absolute top-[500px] left-[3vw] "
            data-scroll
          ...
          {/* shape 2*/}
          <div
            className="absolute top-[240px] lg:left-[35vw]"
            data-scroll
          ...
          {/* shape 3*/}
          <div
            className="absolute top-[480px] lg:left-[45vw]"
            data-scroll
